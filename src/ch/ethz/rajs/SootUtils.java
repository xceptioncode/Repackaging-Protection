...
public class SootUtils {
    ...
    // To maintain the list of statements which couldn't be transformed, used for restoring string equality statements to maintain program semantics
    //public static List<Unit> notTransformed = new LinkedList<Unit>();
    public static Set<Unit> notTransformed = new HashSet<Unit>();

    public static boolean basicTest(Chain<Unit> units, IfStmt stmt)
    {
    ...
    public static void findStatements(PatchingChain<Unit> units, Unit start, Unit end) {
        List<Unit> origBodyUnitsList = new ArrayList<>(units);
        List<Unit> blockStmts = new LinkedList<Unit>();
        ...
        for(int i = startIdx; i < endIdx; i++) {
            blockStmts.add(origBodyUnitsList.get(i));
        }
