...
import static ch.ethz.rajs.Main.architecture_all;
...
//        if (res.contains("armeabi-v7a") && !(res.contains("arm64-v8a"))) {
//                System.err.println("arm64-v8a not found. Exiting...");
//                System.exit(1);
//            }

//        if (res.remove("armeabi-v7a")) // due to error with native
//        {
//            System.err.println("Ignoring armeabi-v7a for testing.\n");
//        }
